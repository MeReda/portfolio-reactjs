...
const Skills = () => {
  ...
  return (
    <>
      <div className="container about-page d-flex align-items-center h-100 w-100 p-5">
        <div className="row d-flex align-items-center gap-5 m-5 p-5 justify-content-center">
          <div className="text-zone col-md-6 me-5">
            <h1>
              <AnimatedLetters
